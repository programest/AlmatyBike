(() => {
    ...
    const counters = document.querySelectorAll(".statistics__zag");
    ...
    let center = [ 43.241871165741784, 76.93440637740967 ];
    function init() {
        new ymaps.Map("map", {
            center,
            zoom: 15
        ...
        new ymaps.Placemark(center, {}, {
            ...
            iconImageHref: "https://stock.adobe.com/images/id/298285715?as_campaign=Flaticon&as_content=api&as_audience=404&tduid=e587dc1024d2193fee07f4c831487288&as_channel=affiliate&as_campclass=redirect&as_source=arvato",
            iconImageSize: [ 40, 40 ],
            iconImageOffset: [ -19, -44 ]
        });
    }
    ymaps.ready(init);
    const div = document.querySelector(".menu__link-arrow ");
    ...
    window.onscroll = () => {
        if (window.scrollY > 2700) scrollBtn.classList.remove("isShowBtn_hide"); else if (window.scrollY < 2700) scrollBtn.classList.add("isShowBtn_hide");
    };
    class Popup {
        constructor(options) {
            let config = {
